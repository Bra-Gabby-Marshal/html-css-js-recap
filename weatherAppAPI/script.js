...
const updateForcastsItemsContainer = document.querySelector('.forecast-items-container')
...
const apiKey = 'db9b49bdf68a5a57ac4551209374eaac'
...
async function updateForcastsInfo(city) {
    ...
    updateForcastsItemsContainer.innerHTML = ''
...
function updateForcastsItems(weatherData) {
    ...
    updateForcastsItemsContainer.insertAdjacentHTML('beforeend', forecastItem)
}
